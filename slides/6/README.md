...
|---|---:|
| Ouverture | 3 |
| Signaux de cohérence | 36 |
| Traversabilité | 21 |
| Manipulation et perception interactive | 27 |
| Environnements dynamiques | 27 |
| Synthèse | 3 |
| **Total** | **117** |
...
- InfoNCEDemo : température, poids et perte
- MaskedPatchesDemo : masquage et cibles de reconstruction
- PositiveUnlabeledDemo : passage connu et régions non étiquetées

Réutilisés et adaptés depuis les supports existants :

- PhotometricWarpAnimation (réécriture du calcul en interpolation bilinéaire)
